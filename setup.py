...
setup(
    name="geotagx-formatter",
    version=find_version("src", "__init__.py"),
    description="The GeoTag-X Project formatter Tool.",
    ...
    url="https://github.com/geotagx/geotagx-tool-formatter",
    download_url="https://github.com/geotagx/geotagx-tool-formatter",
    classifiers=[
    ...
    platforms="any",
    license="MIT",
    packages=["geotagx_formatter"],
    package_dir={"geotagx_formatter": "src"},
    entry_points={
        "console_scripts":[
            "geotagx-formatter=geotagx_formatter.__main__:main"
        ]
    }
)
